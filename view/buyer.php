...
<?php
    ...
    if($conn->connect_error)
  	...
  	if($res->num_rows>0){
        echo '<form method="POST" action="buyer.php">';
  		...
  		<div class="col-sm-6">
            <div class="panel panel-primary">
              ...
              <div class="panel-footer">
              		...
              		<br>
              		<p><strong>ANSWER: </strong>'.$row["answer"].'</p><br>
    ...
    if(isset($_POST["dismiss"])){
        ...
        if(!$conn->query($del))
        	echo '<script>alert("Not dismissed")</script>';

        echo '<script>window.location.replace("buyer.php")</script>';
